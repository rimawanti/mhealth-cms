...
<div class="row">
	<div class="col-lg-12">		<h1 class="page-header"></h1>
			<div class="panel panel-info"> 
				 <div class="panel-heading">Create New Data Pemeriksaan</div>
				 	...
				 	{!! Form::open(array('route' => 'pemeriksaan.store','class' => 'form-horizontal','id'=>'predict_form')) !!}
					 	<fieldset>
						 	...
						 	<div class="form-group">
							 	...
							 	<div class="col-md-9">
							 	<input type="datetime-local" name="tanggal" class="form-control" placeholder="Tanggal pemeriksaan dilakukan">
							 		{{-- {{ Form::datetime-local('tanggal',null,array('class' => 'form-control','placeholder'=>'Tanggal pemeriksaan here...')) }} --}}
							 	</div>
						 	</div>
							<div class="form-group">
