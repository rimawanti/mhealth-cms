...
<html>
<head>
	<title>Data Prediksi | Edit $prediksi->pasien_id </title>
</head>
<style>
/* Center the loader */
#loader {
...
<div class="row">
	<div class="col-lg-12">		<h1 class="page-header"></h1>
			<div class="panel panel-info"> 
				 <div class="panel-heading">Edit Prediction {{ $prediksi->pasien->nama }}</div>
				 	...
				 	<!-- panel body -->
				 	{!! Form::model($prediksi, ['route' => ['prediksi.update',$prediksi->id], 'method' => 'PUT','class' => 'form-horizontal' ]) !!}
					 	<fieldset>
						 		<div class="form-group">
							 	{{ Form::label ('nama_label','Nama Pasien',array('class' => 'col-md-2 control-label')) }}
							 	<div class="col-md-9">
							 		{{ Form::select($prediksi->pasien_id,$listpasien,null,array('class' => 'form-control','placeholder'=>'Your Patient Name here','required'=>'required')) }}
							 	</div>
						 	</div>
						 	<div class="form-group">
						 	...
						 	<div class="form-group" id="class_div">
							 	...
							 	<div class="col-md-9">
							 		{{ Form::text('class','It will shows yes or nah',array('class' => 'form-control','disabled'=>'disabled','id'=>'class')) }}
							 	</div>
						 	</div>
						 	<div class="form-group" id="nilai_div">
							 	{{ Form::label ('nilai_label','Nilai Prediksi',array('class' => 'col-md-2 control-label','id' => 'nilai_label')) }}
							 	<div class="col-md-9">
							 		{{ Form::text('nilai',null,array('id'=>'nilai','class' => 'form-control','placeholder'=>'Nilai prediksi...','disabled'=>'disabled')) }}
							 	</div>
						 	</div>
