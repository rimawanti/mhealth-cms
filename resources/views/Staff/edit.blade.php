	...
	<div class="col-lg-12">
		<h1 class="page-header"></h1>
			<div class="panel panel-info"> 
				 <div class="panel-heading">Edit data {{ $staff->nama }}</div>
				 	<div class="panel-body">
				 	<!-- panel body -->
				 	{!! Form::model($staff, ['route' => ['staff.update',$staff->id], 'method' => 'PUT','class' => 'form-horizontal','files' => true ]) !!}
					 	...
					 	<fieldset>
						 	...
						 	{{-- {!! Html::linkRoute('staff.update','Save Changes',array($staffs->id),array('class'=> 'btn btn-primary pull-right')) !!} --}}
					 	</fieldset>
				 	{!! Form::close() !!}
